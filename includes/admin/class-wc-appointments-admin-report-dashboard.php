	...
	public static function add_stats_to_dashboard() {
		...
		<li class="processing-orders">
			<a href="<?php echo esc_html( admin_url( 'edit.php?post_type=wc_appointment&post_status=paid' ) ); ?>">
				...
				printf( wp_kses_post( _n( '<strong>%s appointment</strong> new this month', '<strong>%s appointments</strong> new this month', 'woocommerce-appointments' ) ), esc_attr( $new_appointments ) );
				?>
			</a>
		</li>
		<li class="low-in-stock">
			<a href="<?php echo esc_html( admin_url( 'edit.php?post_type=wc_appointment&post_status=pending-confirmation' ) ); ?> ">
				...
				printf( wp_kses_post( _n( '<strong>%s appointment</strong> requires confirmation', '<strong>%s appointments</strong> require confirmation', 'woocommerce-appointments' ) ), esc_attr( $require_confirmation ) );
				?>
			</a>
		</li>
		<?php
